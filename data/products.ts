...
export const CITY_ARABIC_NAMES: Record<MoroccanCity, string> = {
...
export const PRODUCTS: Product[] = [
  {
    ...
    bundleOptions: [
      ...
      },
      {
        ...
        deliveryFee: 0,
        savings: 129,
        badge: "الأكثر طلباً - وفر 50 درهم",
        badgeFr: "Le Plus Demandé - Économisez 50 DH",
        isPopular: true,
      },
    ],
    faq: [
