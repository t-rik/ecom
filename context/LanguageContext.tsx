...
export const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    full_name_placeholder: "محمد الإدريسي",
    ...
    address_placeholder: "الحي، رقم الشارع، الإقامة...",
  ...
  fr: {
    ...
    full_name_placeholder: "Ex: Mohamed Idrissi",
    ...
    address_placeholder: "Quartier, N° rue, Résidence, Appartement...",
