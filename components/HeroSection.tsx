...
export default function HeroSection({ product }: HeroSectionProps) {
  ...
  return (
    <section className="w-full bg-white pb-6 pt-4 px-4 border-b border-gray-100">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-700 text-sm sm:text-base leading-relaxed mb-4 bg-gray-50/80 p-3 rounded-xl border border-gray-100">
          {product.subtitle}
        </p>
